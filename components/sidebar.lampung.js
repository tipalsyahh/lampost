    ...
    <nav class="navbar-sub">
        <ul>
            ...
            <li class="has-sub">
                <a href="#">Ekonomi</a>
                <ul class="sub-menu">
                    <li><a href="#">Bank Indonesia Lampung</a></li>
            ...
            <li class="has-sub">
                <a href="#">Lampung</a>
                <ul class="sub-menu">
                    <li><a href="bandar-lampung.html">Bandar Lampung</a></li>
                    <li><a href="../../microweb/pemprovlampung.html">Pemprov Lampung</a></li>
                    <li><a href="lampung-barat.html">Lampung Barat</a></li>
                    <li><a href="lampung-timur.html">Lampung Timur</a></li>
                </ul>
            </li>
            ...
            <li id="link-mobile"><a href="#">Tokoh</a></li>
